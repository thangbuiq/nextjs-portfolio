...
const Head = () => {
  ...
  return (
    <>
      ...
      <meta property='og:url' content={`https://thangbuiq.vercel.app${pathname}`} />
      <link rel='canonical' href={`https://thangbuiq.vercel.app${pathname}`} />
      ...
      <meta name='twitter:site' content='@thangbuiq_' />
