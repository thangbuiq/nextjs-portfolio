    ...
    <Timeline>
      ...
      <TimelineEvent active>
        ...
        <TimelineEvent.Description>
          AI Engineer, working on the deployment of AI applications using Kubernetes, ArgoCD, Helm and GitHub Actions, also working on the development of NLP, CV models using Python, TensorFlow, PyTorch, FastAPI, and LLM agent with llama-index.
        </TimelineEvent.Description>
