  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-end gap-3'>
        ...
        <ExternalLink href={repo} customClassName='text-white inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-600 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
        ...
        <ExternalLink href={link} customClassName='text-white inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-600 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
